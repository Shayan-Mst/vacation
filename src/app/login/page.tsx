...
const page = () => {
  ...
  if(email == account_data.email && password == account_data.password){
    ...
    setTimeout(()=>{
     ...
     Loader.style.borderRightColor = "#4BB543"
    },1000)
...
<div className="login-content">
  ...
  <line x1="9" y1="9" x2="15" y2="15"/>
    ...
    <div className="form-group">
      ...
      <input value={password} onChange={(e)=>setPassword(e.target.value)} className="bg-gray-100" type="password" id="password" name="password" required/>
