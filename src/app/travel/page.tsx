...
<svg className='mr-4' width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.552"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> 
<path fill-rule="evenodd" clip-rule="evenodd" d="M21.5821 5.54289C21.9726 5.93342 21.9726 6.56658 21.5821 6.95711L10.2526 18.2867C9.86452 18.6747 9.23627 18.6775 8.84475 18.293L2.29929 11.8644C1.90527 11.4774 1.89956 10.8443 2.28655 10.4503C2.67354 10.0562 3.30668 10.0505 3.70071 10.4375L9.53911 16.1717L20.1679 5.54289C20.5584 5.15237 21.1916 5.15237 21.5821 5.54289Z" fill="#ffffff"></path> </g></svg>
...
Exclusive Extras Just for Members
</div>
<div className='flex my-3'>
<svg className='mr-4' width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.552"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> 
...
<div className='bg-gray-300 rounded-md px-4 py-12'>
...
<p style={{color:"#003087"}} className='my-4 text-center'>Cars Search</p>
</div>
...
<p style={{color:"#003087"}} className='my-4 text-center'>Flights Search</p>
</div>
...
<div className='bg-white rounded-md p-4 py-8 hover:opacity-70 cursor-pointer'>
    ...
    <p style={{color:"#003087"}} className='my-4 text-center'>Hotels Search</p>
...
<p style={{color:"#003087"}} className='my-4 text-center'>Cruises Search</p>
</div>
...
<div className='bg-white rounded-md p-4 py-8 hover:opacity-70 cursor-pointer'>
    ...
    <svg className='mx-auto' xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 20.707 20">
...
<p style={{color:"#003087"}} className='my-4 text-center'>Activities Search</p>
...
<svg className='mx-auto' width="40" height="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 62.2"><g data-name="Layer 2"><path d="m63.84 49.6-6.6-10.07 3.5-6.36c1.87-3.46.61-6.56-1.61-7.82a4.89 4.89 0 0 0-2-.57V19.2a7.34 7.34 0 0 0-7.33-7.33h-4.4V6.76A6.78 6.78 0 0 0 38.61 0H17.23a6.78 6.78 0 0 0-6.77 6.76v5.1H7.33A7.34 7.34 0 0 0 0 19.2v25.86a7.34 7.34 0 0 0 7.33 7.34h25.43a1 1 0 0 0 .76 1l5.25 1.23A3.64 3.64 0 0 0 40 59a2.58 2.58 0 0 0 .32.18l.28.16a3.66 3.66 0 0 0 4.35-1.23l3.8 3.81a1 1 0 0 0 .71.29h.13a1 1 0 0 0 .74-.49l2-3.5a1 1 0 0 0 0-1L49 52l2.88-4.28 7.84 7.62a1 1 0 0 0 1.57-.22l2.55-4.46a1 1 0 0 0 0-1.06zM12.48 13.87h7.91v3.31h-7.91zm8.91-2h-3.34V8.32a1 1 0 0 1 1-1h17.74a1 1 0 0 1 1 1v3.55h-16.4zm14.09 2h7.91v3.31h-7.91zM13.86 3.41A4.74 4.74 0 0 1 17.23 2h21.38a4.77 4.77 0 0 1 4.76 4.76v5.1h-3.55V8.32a3 3 0 0 0-3-3H19.07a3 3 0 0 0-3 3v3.55h-3.59V6.76a4.71 4.71 0 0 1 1.38-3.35zM7.33 13.87h3.14v4.31a1 1 0 0 0 1 1h9.91a1 1 0 0 0 1-1v-4.31h11.1v4.31a1 1 0 0 0 1 1h9.91a1 1 0 0 0 1-1v-4.31h4.39a5.34 5.34 0 0 1 5.33 5.33V25a6.47 6.47 0 0 0-3.5 3.07l-3.56 6.32-12-.31a1 1 0 0 0-.9.52L33 38.5H2V19.2a5.34 5.34 0 0 1 5.33-5.33zM2 45.06V40.5h31.14a1 1 0 0 0 .18.09l10.61 2.65-2.12 4.7-6.14-.06a1 1 0 0 0-.89.53l-1.06 2H7.33A5.34 5.34 0 0 1 2 45.06zM60.22 53l-7.77-7.56a1 1 0 0 0-1.53.16L47 51.4a1 1 0 0 0 0 1.09l3.31 5.23-1.08 1.85-3.73-3.73a1 1 0 0 0-.71-.29h-.1A1 1 0 0 0 44 56l-.17.27c-.45.8-1.51 1.68-2.3 1.29l-.13-.07-.3-.17c-.77-.48-.57-1.85-.1-2.71l.1-.22a1 1 0 0 0-.72-1.39l-5.14-1.2 1-1.89 6.19.06a1 1 0 0 0 .92-.59L46.24 43a1 1 0 0 0-.67-1.38L35.05 39l1.54-2.84 12 .31a1.07 1.07 0 0 0 .9-.51l3.85-6.83c1.38-2.41 3.45-2.72 4.79-2s2.15 2.69.83 5.12L55.2 39.1a1 1 0 0 0 0 1l6.59 10.05z" data-name="business trip"/></g></svg>

<p style={{color:"#003087"}} className='my-4 text-center'>Trips Search</p>
